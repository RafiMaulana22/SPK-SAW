        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
                <div class="flex-row text-center mx-auto">
                    <img src="{{ asset('') }}assets/img/pages/profile-banner-filwork.png" alt="Auth Cover Bg color" width="1000"
                        class="img-fluid authentication-cover-img" data-app-light-img="pages/profile-banner-filwork.png"
            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <div class="app-brand mb-4">
                        <a href="i" class="app-brand-link gap-2 mb-2">
                            ...
                            <span class="app-brand-text demo h3 mb-0 fw-bold">FilWork</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    @yield('content')
