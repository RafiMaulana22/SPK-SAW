    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card mt-2">
                ...
                <div class="card-body">
                    <form class="needs-validation" action="/alternatif" method="POST" novalidate>
                        @csrf
                        <div class="mb-3">
        ...
        <div class="col-md-9">
            <div class="card mt-2">
                <h5 class="card-header">Data Alternatif</h5>
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody class="table-border-bottom-0">
                                @foreach ($alternatif as $get)
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                        href="/alternatif/{{ $get->id }}/edit">
                                                        <i class="bx bx-edit-alt me-1"></i> Edit
                                                    </a>
                                                    <button class="dropdown-item" data-bs-toggle="modal"
                                                        data-bs-target="#hapus{{ $get->id }}">
                                    ...
                                    <!-- Modal Hapus-->
                                    <div class="modal fade" id="hapus{{ $get->id }}"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Anda akan menghapus data dengan Alternatif
                                                    <b>{{ $get->nama_alternatif }}</b>?
                                                </div>
                                                <div class="modal-footer">
                                                    <a class="btn btn-danger"
                                                        href="/alternatif/{{ $get->id }}/hapus">Hapus</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
